...
echo ""
echo "=== 步骤 5: 检查 APISIX 容器状态 ==="
docker-compose ps

echo ""
echo "=== 步骤 6: 检查 9443 端口占用情况 ==="
# 使用 ss 命令替代 netstat
