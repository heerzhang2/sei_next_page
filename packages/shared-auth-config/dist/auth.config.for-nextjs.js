...
export const authConfig = {
    ...
    callbacks: {
        ...
        async jwt({ token, user, trigger, session }) {
            // 初次登录
            if (user) {
                console.log("[Auth] 初次登录 - 保存 token 信息");
                return {
                    ...token,
            ...
            if (trigger === "update" && session?.user) {
                console.log("[Auth] 更新 token - 合并新的 token 信息");
                return {
                    ...token,
