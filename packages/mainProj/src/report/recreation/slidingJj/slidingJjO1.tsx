...
export const config观测数据: ((orc: any) => EachObserveConfig[][]) = (orc: any) => {
    return [
        [{
            n: '型钢厚',
            t: ['K2.4', '(1)', `结构件的最大锈蚀深度应当小于原型钢厚度的15%。抽查的结构件为（${orc?.抽查构件 ?? ''}）。`],
            x: '原型钢厚度',
            u: 'mm',
            c: '四',
            d: 1,
        ...
        [{
            n: '磨轴原径',
            t: ['K2.6', '(1)', <div key='1' className="">磨损量和锈蚀量应符合维护保养说明书及以下要求，重要轴（销轴）最大磨损量应当小于原直径的0.8%，且最大值不超过
                1mm;重要轴（销轴）的锈蚀量(经打磨后)，应当小于原直径的1%(包括凹坑处），且最大不超过1mm。磨损最大的重要轴（销轴）
                为（{orc?.销轴损最 ?? ''}）；锈蚀最大的重要轴（销轴）为（{orc?.销轴锈最 ?? ''}）。</div>],
            x: '最大磨损轴原直径',
            u: 'mm',
            c: '四',
            d: 1,
        ...
        [{
            n: '道原厚',
            t: ['※K2.12.3', '(1)', <>型钢轨道磨损量应当小于原厚度尺寸的20%；钢管轨道磨损量应当小于原钢管壁厚的15%。轨道型式为（{orc?.道型式 ?? ' '}）。</>],
            x: '轨道原厚度（壁厚）值',
            u: 'mm',
            c: '四',
            d: 1,
        ...
        [{
            n: '轨距设',
            t: ['K2.12.4', '(1)', <>侧轮在轨道内时轨距允 许误差为-3mm～5mm,侧轮在轨道外时轨距允许误差为-5mm～3mm,木制轨道轨距允许误差为
                -5mm～6mm。
                侧轮在轨道（{orc?.侧轮哪侧 ?? ' '}）侧； （{orc?.木质轨 ?? ' '}）木质轨道。</>],
            x: '轨距设计值',
            u: 'mm',
            c: '四',
            d: 0,
        ...
        [{
            n: '接口高差',
            t: ['K2.12.5', '(1)', '轨道与车轮接触面的接口处高低差应当不大于 1 mm。'],
            x: '轨道接口处高低差',
            u: 'mm',
            c: '四',
            d: 1
        ...
        [{
            n: '卷筒径',
            t: ['K3.5.2', '(1)', <>提升乘人装置用的卷筒、滑轮直径与钢丝绳直径之比应当不小于30；钢丝绳对滑轮包角不大于90°时，滑轮直径与钢丝绳直径之比应当不小于20。</>],
            x: '卷筒直径',
            u: 'mm',
            c: '四',
            d: 1
        ...
        [{n: '断丝数', t: ['K3.5.5', '(1)', '一个捻距内的断丝数。'], x: '断丝数', u: '根', c: '四', d: 0},
            {
                n: '绳原直径',
                t: [undefined, undefined, '磨损后钢丝绳直径为原直径的90%以上。'],
                x: '钢丝绳原直径',
                u: 'mm',
                c: '四',
                d: 1
...
export const config观测数据2: ((orc: any) => EachObserveConfig[][]) = (orc: any) => {
    return [
        [{
            n: '主轮原直',
            t: ['※K3.8', '(1)', <>滑行车车轮的磨损量应当小于原直径尺寸的
                2.5%，且主车轮最大磨损量不超过6mm，侧轮和底轮最大磨损量不超过4mm。</>],
            x: '主车轮原直径',
            u: 'mm',
            c: '四',
            d: 1
        ...
        [{
            n: '绝缘阻',
            t: ['※K4.4', '(1)', '电压有效值大于50V的带电回路与接地装置之间的绝缘电阻应当能保证用电安全，绝缘电阻应当不小于1MΩ。'],
            x: '绝缘电阻',
            u: 'MΩ',
            c: '四',
            d: 1
        ...
        [{
            n: '轨绝缘阻',
            t: ['K4.5', '(1)', "路轨与导电轨之间的绝缘电阻应当不小于 0.1MΩ。"],
            x: '绝缘电阻',
            u: 'MΩ',
            c: '四',
            d: 2
        ...
        [{
            n: '座舱深',
            t: ['K5.2', '(1)', <>座席距地面最大高度5m以下时, 座舱深度不小于550mm, 座席靠背高度不小于300mm。座席距地面最大高度5m以上时,
                座舱深度不小于800mm,座席
                靠背高度不小于400mm。当设有安全杠和安全带等设施时, 可适当减少座舱深度。
                座席距地面最大高度（{orc?.座席高 ?? ' '}）m。</>],
            x: '座舱深度',
            u: 'mm',
            c: '四',
        ...
        [{
            n: '满制距',
            t: ['※K6.2', '(4)', '在满载工况下最大速度运行时的制动距离，应符合设计文件要求。'],
            x: '制动距离',
            u: 'm',
            c: '四',
            d: 1
            ...
            {
                n: '闸衬厚',
                t: [undefined, '(5)', '对有磨损的机械式制动装置在磨损严重部位测量闸衬厚度，磨损量应当不大于原厚度50%且满足设计文件要求。'],
                x: '磨损后闸衬厚度',
                u: 'mm',
                c: '四',
                d: 2
        ...
        [{
            n: '栅栏高',
            t: ['K6.20', '(1)', '安全栅栏高度应当不低于1100mm；栅栏的间隙和距离地面的间隙应当不大于 120mm。'],
            x: '高度',
            u: 'mm',
            c: '四',
            d: 0
        ...
        [{
            n: '台阶纵宽',
            t: ['K6.22', '(1)', <>台阶踏面纵向宽度应当不小于240mm，高度为140mm～200mm；进出口为斜坡时，坡度应当不大于1 :
                6，有防滑措施的斜坡，坡度应当不大于1 : 4。</>],
            x: '台阶踏面纵向宽度',
            u: 'mm',
            c: '四',
            d: 0
