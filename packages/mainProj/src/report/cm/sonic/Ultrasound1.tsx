...
export const UltrasoundVw = ({
    ...
    const render=()=><>
        <FlexibleTable id={'SoniInstrument_'+redId} columnWidths={ ["5%", "5%", "25%", "5%", "4%","22%", "6%","5%", "%"] } className="text-sm border-collapse">
            <TableBody>
...
//编辑器2列；显示需改为3列的：
export const config磁粉概要 = mergeToThreeColumn(config超声仪概);
