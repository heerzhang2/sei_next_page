 ...
 * */
export const ThickMs = ({ rep, children, show = true, label }: InternalItemProps) => {
 ...
 * */
export const ThkmsInstrument = ({ rep, children, show = true, label }: InternalItemProps) => {
                            ...
                            <div key={0}>
                                ...
                                >
                                    <div className="flex-1 grid grid-cols-2 gap-2 items-center">
                                        <div className="col-span-2 text-sm text-black min-w-0">{content}</div>
                                    </div>
