...
export function useTableEdit({
    ...
    const handleCancel = React.useCallback(
        ...
        [form, seq, config, table, localTableData, remove, handleTableOperation, isEditingNewRow, externalData],
    )
        ...
        if (noDelAdd && seq === null) return null
            ...
            return (
                ...
                >
                    ...
                    <div className={cn("w-full", "flex-1 overflow-y-auto py-1")}>
                            ...
                            {seq !== null && (
                                <>
                                    {editAs ? (
                                        ...
                                        <div className="grid grid-cols-1 @xl:grid-cols-2 @5xl:grid-cols-3 @7xl:grid-cols-4 gap-2 py-1">
                                                ...
                                                if (type === "s")
                                                    ...
                                                    return (
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem className="w-full break-inside-avoid flex flex-col justify-center gap-1">
                                                                    <FormLabel htmlFor={eiid} className="select-text">
                                                                        {title}
                                                                    </FormLabel>
                                                                    <FormControl className="w-full">
                                                                        <Switch id={eiid} checked={field.value || false}
                                                                            name={field.name} onCheckedChange={field.onChange}
                                                                            className={cn(
                                                                                "ml-8 h-[25px] w-[42px] [&>span]:h-[21px] [&>span]:w-[21px] [&>span]:data-[state=checked]:translate-x-[17px]",
                                                                            )}
                                                                        />
                                                                    </FormControl>
                                                                    <FormMessage />
                                                    ...
                                                    return (
                                                        <FormField
                                                            ...
                                                            name={park ? `${table}.${index}.${park}.${tag}` : `${table}.${index}.${tag}`}
                                                            render={({ field }) => (
                                                                <FormItem className="w-full break-inside-avoid @5xl:col-span-2 flex flex-col justify-center gap-1">
                                                                    <FormLabel className="select-text">{title}</FormLabel>
                                                                    <FormControl className="w-full">
                                                                        <BlobInputList
                                                                            datalist={list}
    ...
    const showEditorAtRowFn = React.useCallback(
        ...
        [pageIndexToGlobalIndex, localTableData, config, table, editorPosition?.visibility, showEditorPortal],
    )
                                                            ...
                                                            <div className="flex flex-wrap justify-start items-stretch w-full min-h-[inherit] gap-0">
                                                                {config.map(([title, tag, width, _o, park]: any, k: number) => {
                                                                    ...
                                                                    return (
                                                                        ...
                                                                        >
                                                                            <div className={cn("m-auto", cellText)}>{zdvalue || "\u00A0"}</div>
                                                                        </div>
                                                                    )
                                                                })}
                                                            </div>
    ...
    // Use useCallback wrapped setFixedColW function, avoid unnecessary re-creation
    ...
    // Modify clearTable function, also update local state
