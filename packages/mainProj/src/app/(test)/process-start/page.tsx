...
export default function ChromeGuidePage() {
    ...
    return (
        <div className="container mx-auto py-8 px-4">
            <h1 className="text-3xl font-bold mb-6">解决Chrome私有网络请求限制</h1>
            ...
            <Tabs defaultValue="command">
                <TabsList className="mb-4">
                    <TabsTrigger value="command">启动参数方法</TabsTrigger>
                    <TabsTrigger value="flags">Chrome标志方法</TabsTrigger>
                    <TabsTrigger value="policy">企业策略方法</TabsTrigger>
                </TabsList>
