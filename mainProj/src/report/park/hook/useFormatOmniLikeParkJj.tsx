 ...
 * */
export const useFormatOmniLikeParkJj= ({itRes, ItemArs, rep }
                ...
                if(et){
                    ...
                    itemRowRender[0] =<TableRow id={n===0 ? area.tag:undefined} key={n}>
                        ...
                        {et.fRSpan && <>
                            ...
                            <CCell key={11}  rowSpan={et.fRSpan??1}>{itRes?.[icname+'_Z']}</CCell>
                            <CCell key={12}  rowSpan={et.fRSpan??1}>{itRes?.[icname+'_S']}</CCell>
