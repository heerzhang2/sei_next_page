...
export function useTableEdit({
  ...
  const editor = React.useCallback(
        ...
        return (
            <Card
                className={cn(
                    ...
                    showEditorPortal && "max-h-[70vh] overflow-y-auto", // 添加滚动支持
                )}
                ref={editorRef}
            >
              <div className="flex justify-between items-center sticky top-0 bg-background z-10 p-2">
                ...
                {showEditorPortal && (
                    <Button variant="ghost" size="sm" className="ml-auto" onClick={handleCloseEditor}>
                      关闭
                    </Button>
                )}
              </div>
      ...
      [seq, config, table, editAs, fixColumn, localTableData, handleTableOperation, noDelAdd, showEditorPortal],
  )
