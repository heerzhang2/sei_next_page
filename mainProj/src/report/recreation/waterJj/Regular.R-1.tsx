...
import {检验核准WaterJj, 注意事项WaterJj, 首页概况WaterJj} from "./rarelyVary";
...
const JumpTags=[{name:'设备概况',ha:'Survey'},{name:'K1资料审查',ha:'1.1'},{name:'电气及控制系统',ha:'4.1'},
            {name:'K7载荷试验',ha:'7.1'},{name:'水上游乐设施专项检验',ha:'8.17'},{name:'现场检验条件确认',ha:'SiteCondition'}];
      ...
      {rootMenu}
       <div css={{"@media not print": {marginTop: '1rem', marginBottom: '1rem'}}}>
            <div css={{"@media print": {height: '100vh'}}}>
                {ReportFirstPageHeadJd({theme, rep, mbbm: 'FJJ/YB-1006-2024'})}
                <div css={{
                    "@media print": {
                        display: 'flex',
           ...
           <DirectLink href={`/report/${rep?.modeltype}/ver/${verId}/${repId}/Instrument`}>
               <div css={{display: 'flex', flexDirection: 'column', justifyContent: 'center', "@media print": {pageBreakBefore: 'always',},}}>
                   <Text variant="h4" css={{textAlign: 'center'}}></Text>
               </div>
           ...
           <Text css={{"@media print": {fontSize: '0.75rem'}}}>注：※为重要项，其它为一般项。</Text>
