...
export const 填写须知recr = <>
  <div className="print:h-screen print:break-after-page flex flex-col justify-evenly">
    {/* 标题 */}
    <span className="block text-xl print:text-3xl mb-[3rem] text-center">填 写 须 知</span>
    {/* 正文内容 */}
    <span className="leading-4 print:leading-10">
      1、本记录适用于滑行车类、架空游览车类大型游乐设施的监督检验。<br/>
      2、检查结果栏“[ ]”可用以下四种符号表示记录内容：<br/>
      {/* 符号说明（左对齐弹性容器） */}
      <span className="flex flex-col ml-[2rem] space-y-2">
      ...
      4、监督检验项目分为I、II两类： <br/>
      {/* 结论符号说明 */}
      <span className="flex flex-col ml-[2rem] space-y-1">
