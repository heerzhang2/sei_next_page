...
export const FormatOriginal: React.FunctionComponent<ReportViewProps> = ({
    ...
    const {renderIspContent} =useFormatOmniLikeSund({itRes:orc,ItemArs:impressionismAs?.Item, rep});
  ...
  return (
    <React.Fragment>
        ...
        >
            ...
            <Text id={'_See_Memo1'}>
                注：<br/>
                (1)对于允许按照 JG 135-2000 及更早期标准生产的杂物电梯，如果 A3.2.4.4 条、A3.2.5.7 条第(2)项、A3.3.1
                条第(2)和第(3)项、A3.3.2
                条第(2)项以及本附件 A3.2.5.7 条第(3)项间接机械连门扇中未被锁住门扇上的电气安全装置未按照《电梯监督检验和定期检验规则一一杂
                物电梯》(TSG T7006-2012)进行过检验，并日未按照《电梯监督检验和定期检验规则》(TSG T7001-2023)进行过监督检验，定期检验时
                可以不检验;
            </Text><br/>
            <Text id={'_See_Memo2'}>
                (2)如果 A3.2.4.3 条未按照《电梯监督检验和定期检验规则》(TSG
                T7001-2023)进行过监督检验，定期检验时可以不检验:
            </Text><br/>
            <Text id={'_See_Memo3'}>
                (3)A3.2.2.3 条第(3)项、A3.2.3.1 条、A3.2.3.2 条、A3.3.5 条第(2)项仅适用于《电梯监督检验和定期检验规则》(TSG
                T7001-2023) 第4.1
                条第(2)项所述杂物电梯的定期检验，其余项目适用于第4.1 条第(1)和第(2)项所述杂物电梯的定期检验。
            </Text>
            <Text variant="h4" css={{
                marginTop: '1rem',
                "@media print": {
            ...
            <Text variant="h4" css={{marginTop: '1rem',}}>附录A：现场检验条件确认</Text>
