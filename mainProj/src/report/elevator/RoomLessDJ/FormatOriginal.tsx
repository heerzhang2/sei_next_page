...
export const FormatOriginal: React.FunctionComponent<ReportViewProps> = ({
    ...
    const {renderIspContent} =useLikeElevatorSuperv({itRes:orc,ItemArs:impressionismAs?.Item,
        model:'ROL-DJ',ver:verId, repNo:`${repId}`, rssCB:特殊输入显示});
    ...
    <React.Fragment>
      ...
      >
        ...
        {/*{检验设备情况({orc, repId:repId!, verId})}*/}
          ...
          <DirectLink  href={`/report/ROL-DJ/ver/${verId}/${repId}/Evaluation`}>
          ...
          { orc?.unq?  <>
                  <Table  fixed={ ["5%","11%","%","14%","14%"]  }    printColWidth={ ["26","49","520","52","71"] }
                      ...
                      <TableBody>
                          <DirectLink  href={`/report/ROL-DJ/ver/${verId}/${repId}/ReCheck?original=1#ReCheck`}>
                              <TableRow>
                  ...
                  >
                      ...
                      <TableBody>
                          {orc?.unq?.map((bug:any, i:number) => {
                              return (
                                  <DirectLink key={i} href={`/report/ROL-DJ/ver/${verId}/${repId}/${mapNoTag.get(bug.no)}?original=1`}>
                                    <TableRow >
              ...
              :
              <DirectLink  href={`/report/ROL-DJ/ver/${verId}/${repId}/ReCheck#ReCheck`}>
