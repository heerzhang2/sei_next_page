...
export const tItems现场=[
    ...
    ['3、湿度不影响设备正常运行无凝露',{f:'s',
        N: <Text>3、湿度不影响设备正常运行，电器设备无凝露；</Text>},],
    ['4、相关区域没有与电梯运行无关的物品和设备',{f:'x',
        N: <Text>4、相关区域没有与电梯运行无关的物品和设备，进行了必要的封闭和防护，放置表明正在进行检验的警示标志；</Text>},],
    ['5、维护保养单位安排了专业技术人员',{f:'P',
        N: <Text>5、维护保养单位安排了专业技术人员，配合检验人员实施现场检验。</Text>},]
];　
...
const recordPrintList =[
    ...
    createItem('Conclusion', <ItemConclusion startd={false} label={'五、现场检验意见'}/>),
    ...
    createItem('Gap', <DoorGap label={'附录A 电梯门间隙、锁紧元件啮合长度等检验记录'}/>),
    createItem('SiteCondition', <SiteConditionSund config={tItems现场} label={'附录B：现场检验条件确认'}/>),
    createItem('MonitoringFacili', <MonitoringFacili label={'附录C 视频监控设施、远程监测装置、机房通风降温措施检查记录表'}/>),
];
