...
import {注意事项SundJ, 首页概况SundJ} from "./viewFirst";
...
//页面哈希路由方式；
const JumpTags=[{name:'设备概况',ha:'Survey'},{name:'3.1.1 制造资料',ha:'3.1.1'},
    {name:'3.2.2电气设备和驱动主机',ha:'3.2.2.1'},{name:'3.3.1限速器-安全钳试验',ha:'3.3.1'},{name:'现场检验条件确认',ha:'SiteCondition'}];
    ...
    <React.Fragment>
      {rootMenu}
       <div css={{"@media not print": {marginTop: '1rem', marginBottom: '1rem'}}}>
            ...
            {注意事项SundJ({
                rep,
                comply: '依据《电梯监督检验与定期检验规则》（TSG T7001—2023）制定，适用于曳引驱动杂物电梯、强制驱动杂物电梯、液压驱动杂物电梯、防爆杂物电梯的监督检验'
            })}
        ...
        <div>
            ...
            <Text id={'SiteCondition'} variant="h4" css={{"@media print": {display: 'none'}}}>附录B：现场检验条件确认</Text>
            </RouterLink>
        </div>
