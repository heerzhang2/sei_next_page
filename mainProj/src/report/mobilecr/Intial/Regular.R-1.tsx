...
import {useOfficialOmniLikeMobCrIn} from "../hook/useOfficialOmniLikeMobCrIn";
...
//页面哈希路由方式
const JumpTags=[{name:'设备概况',ha:'Survey'},{name:'2资料和文件审查',ha:'2.1'},
    {name:'3.11电气系统检查',ha:'3.11.1'},{name:'4.5动载荷试验',ha:'4.5'},{name:'现场检验条件确认',ha:'SiteCondition'}];
   ...
   return (
    <React.Fragment>
      ...
      >
       ...
       {注意事项Mbcr({rep,comply:'是依据《起重机械安全技术规程》（TSG 51—2023），对起重机械 进行定期（首次）检验的结论报告。（适用于流动式起重机）'}) }
