...
import { useConfirmIspFeeMutation$data} from "./__generated__/useConfirmIspFeeMutation.graphql";
...
const mutation = graphql`
  mutation useConfirmIspFeeMutation($id: ID!) {
    confirmIspFee(id:$id) {
      bus{
        id, __typename
        feeOk
          ...
          let disposable= commit({
            ...
            * */
            ...
            onCompleted: (response) => {
              ...
              const { confirmIspFee } = response as useConfirmIspFeeMutation$data;
              setResult( confirmIspFee );
      /*     toast({
                title: "后端回答了",
