/**
 * @generated SignedSource<<84477ab077fab25ffe284368d78edfaf>>
...
export type TaskMainQuery$variables = {
...
export type TaskMainQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"TaskList">;
};
export type TaskMainQuery = {
  response: TaskMainQuery$data;
  variables: TaskMainQuery$variables;
};
